...
const Navbar = () => {
  ...
  return (
    <nav className="border-gray-200 bg-[#226cff] dark:border-gray-700 dark:bg-gray-800">
      <div className="flex w-full flex-wrap items-center justify-between p-4">
        ...
        <div
          ...
          } absolute left-0 right-0 top-16 transition-all duration-300 ease-in-out dark:bg-gray-800 md:relative md:top-0`}
        >
          <Link
            href="/team"
            className="mt-40 flex items-center justify-center md:mt-0 md:justify-normal"
          >
            <span className="self-center whitespace-nowrap text-lg text-white">
              Team
            </span>
          </Link>
          <Link
