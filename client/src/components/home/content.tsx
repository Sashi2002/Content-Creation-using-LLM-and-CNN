...
const Content = ({ data }: { data: ResponseInterface }) => {
  ...
  return (
    <div className="absolute bottom-0 right-0 z-50 flex h-[89vh] w-full flex-col overflow-y-auto bg-white shadow-inner drop-shadow-2xl">
      <div className="text-5 xl absolute left-4 top-4  flex flex-row space-x-2">
