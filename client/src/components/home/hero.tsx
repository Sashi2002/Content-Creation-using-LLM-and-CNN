  ...
  return (
    <div className="mt-20 flex w-full flex-col-reverse items-center justify-center space-x-10 lg:flex-row">
      <div className="text-left md:w-3/6">
        ...
        <h2 className="my-12 flex-wrap text-justify text-lg font-bold leading-none tracking-tight text-gray-900 lg:text-2xl xl:text-3xl">
          Unleash your social media potential with{" "}
          <span className="text-[#226cff]">Tag IT</span> the AI powered content
          generator for captions, images, and hashtags.
        </h2>
        <Link href="/featured">
